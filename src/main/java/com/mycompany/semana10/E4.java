...
public static void mostrarTemperaturas(ArrayList <E4> lista) {
...
public static void temperaturaMedia(ArrayList <E4> lista) {
...
public static void diasMasCaluroso(ArrayList <E4> lista) {
...
ArrayList <E4> lista = new ArrayList<>(31);
ArrayList <E4> mostrarCaluroso = new ArrayList<>();
